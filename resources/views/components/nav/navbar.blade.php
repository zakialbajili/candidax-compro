<header class="py-10 absolute top-0 left-0 right-0 bottom-0 flex justify-center w-full h-fit font-poppins">
    <nav class="w-[80%] max-w-[90%] h-[55px] flex justify-between items-center mx-auto font-medium text-primerText">
        ...
        <div class="flex gap-10">
            ...
            <x-nav.linkNav href="/" label="Company"/>
            <x-nav.linkNav href="/" label="Collaboration"/>
            <x-nav.linkNav href="/" label="Services"/>
            <x-nav.linkNav href="/" label="Contact"/>
        </div>
